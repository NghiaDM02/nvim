...
-- Toggle terminal
keymap("n", "<m-f>", "<cmd>lua require(\"nvterm.terminal\").toggle \"float\"<cr>", opts)
keymap("n", "<m-i>", "<cmd>lua require(\"nvterm.terminal\").toggle \"horizontal\"<cr>", opts)
keymap("n", "<m-v>", "<cmd>lua require(\"nvterm.terminal\").toggle \"vertical\"<cr>", opts)
